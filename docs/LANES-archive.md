...
Historical lane logs moved verbatim from `docs/LANES.md` on 2026-08-26 (cleanup batch D3). Protocol and active claims stay in `docs/LANES.md`; new entries go there, never here.
