...
| **ui-tests** | `tests/` | **active** — round-11 task 1 (old spec) done: 908 cases, 907 passed, 1 bug found, closed green by Fable (task 2, `cf72756e`). **New claim** (round 11 task 1, per his instruction in `tests/ui/SPEC.md`, claimed 2026-08-26): starting the ~100-test random-settings run per spec -- see lane log. |
