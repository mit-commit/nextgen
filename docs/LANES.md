...
| **ui-tests** | `tests/` | **done** — task `UI combinatorial test run` (round 11 task 1, 2026-08-26): 908 cases, 907 passed, 1 structural bug found (STOP for Fable) — see lane log + `tests/ui/report.md`. |
