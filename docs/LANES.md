...
| **ui-tests** | `tests/` | **done** — round-11 task 1 (old spec): 908 cases, 907 passed, 1 bug found, closed green by Fable (task 2, `cf72756e`). Round-11 task 1 (new spec, `tests/ui/SPEC.md`, 2026-08-26): `tests/ui/random_settings_test.py`, **RUN COMPLETE — 100 tests, 100 passed, 0 failed, seed 42** — see lane log + `tests/ui/report.md`. |
