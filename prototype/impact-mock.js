...
var IMPACT_MOCK = (function(){
  ...
  var REPOS = [
    ...
    { tier: 'using', name: 'asolarlez/sketch-frontend', url: 'https://github.com/asolarlez/sketch-frontend',
      integration: 'derivative_work',
      desc: 'The Sketch synthesizer frontend, built on StreamIt\'s compiler frontend and IR',
      year: 2020, placeholder: 'stars/activity pending harvest',
      evidence: 'REAL: AUTHORS credits the MIT StreamIt team; sketch.compiler.* embeds StreamIt\'s grammar and IR; older trees keep streamit.frontend.* packages' },
